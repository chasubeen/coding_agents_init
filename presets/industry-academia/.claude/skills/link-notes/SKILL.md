...
python harness/tools/skill_graph_tool.py lint skill_graph/deliverables/YYYY-MM-DD_name.md
```
...
python harness/tools/skill_graph_tool.py sync skill_graph/deliverables/YYYY-MM-DD_name.md
```
